		...
		sass: {
			dev: { // This outputs the expanded css file
                ...
                files: {
					...
					'css/page1.css': 'css/page1.scss',
					'css/page2.css': 'css/page2.scss',
					'css/page3.css': 'css/page3.scss',
					'css/page4.css': 'css/page4.scss',
					'css/page5.css': 'css/page5.scss',
					'css/page6.css': 'css/page6.scss',
					'css/page7.css': 'css/page7.scss'
                }
            },
